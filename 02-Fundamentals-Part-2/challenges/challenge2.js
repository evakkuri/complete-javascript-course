...
1. Write a function 'calcTip' that takes any bill value as an input and returns
  ...
  function type you like the most. Test the function using a bill value of
  100.
...
4. BONUS: Create an array 'total' containing the total values, so the bill +
  tip.
...
array values (so don't store the tip values in separate variables first, but
